...
@section('content')
    ...
    <div class="row">
        <p>Welcome <strong>{{ $user->username }}</strong> to your personal dashboard. For any problem encountered before or during registration, call or send SMS to <strong>08030408344</strong> or email us at:
